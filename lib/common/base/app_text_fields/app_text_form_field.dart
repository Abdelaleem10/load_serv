...
import 'package:loadserv_task/common/presentation/utils/keyboardoverlay.dart';
...
class _AppTextFormFieldState extends State<AppTextFormField> {
  ...
  Widget build(BuildContext context) {
    return TextFormField(
      ...
      cursorColor: widget.cursorColor ?? AppColors.orangeColor,
      ...
      style: TextStyles.regular(
        color: widget.isValid
            ? widget.textColor ?? AppColors.grayColor
            : AppColors.binkColor,
